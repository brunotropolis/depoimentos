...
export const MainLayout = () => {
  ...
  const panelTabs = [
    {
      ...
      label: "Participantes",
      icon: Users,
      description: "Adicione pessoas, fotos e o status de presença.",
      meta: `${conversation.participants.length} pessoas`,
    },
    {
      id: "messages",
      label: "Mensagens",
      icon: MessagesSquare,
      description: "Escreva, reordene e ajuste o horário das mensagens.",
      meta: `${conversation.messages.length} mensagens`,
    },
    {
      id: "settings",
      label: "Aparência",
      icon: SlidersHorizontal,
      description: "Escolha o app, o tema e o fundo.",
    ...
    },
    {
      ...
      label: "Exportar",
      icon: Download,
      description: "Defina tamanho, formato e baixe a imagem.",
  ...
  const quickPresetIds = new Set(["iphone-14-pro", "android-standard", "ipad", "desktop"])
            ...
            <div className="flex flex-wrap items-center justify-between gap-3">
              <div>
                ...
                <div className="text-sm font-semibold text-slate-900">
                  Etapa {resolvedActivePanelIndex + 1} de {panelTabs.length}: {activePanel.label}
                </div>
              ...
              <CardHeader className="space-y-3">
                <div className="flex flex-wrap items-center justify-between gap-3">
                  <div>
                    ...
                    <p className="text-xs text-slate-500">Veja o print em tempo real enquanto edita.</p>
                  </div>
                  <div className="flex w-full items-center gap-2 overflow-x-auto pb-1 sm:w-auto sm:flex-wrap">
                    ...
                    >
                      ...
                      <span className="hidden sm:inline">
                        {ui.showChrome ? "Ocultar moldura" : "Mostrar moldura"}
                      </span>
                    </Button>
                    <Button
                      variant="outline"
                    ...
                    >
                      ...
                      <span className="hidden sm:inline">Diminuir</span>
                    </Button>
                    <Button
                      variant="outline"
                      size="sm"
                ...
                <div className="flex flex-wrap items-center gap-2 text-xs text-slate-500">
                  ...
                  {ui.autoFit ? " (ajuste automático)" : ""} - Tamanho {exportSettings.width} x{" "}
                  {resolvedExportHeight}
                  {exportSettings.captureMode === "full" ? " - todas as mensagens" : ""}
                </div>
                  ...
                  <div className="flex flex-col gap-3 rounded-2xl border border-amber-200 bg-amber-50 px-4 py-3 text-xs text-amber-950 sm:flex-row sm:items-center sm:justify-between">
                    <div className="space-y-1">
                      <div className="font-semibold">
                        Conversa longa: {visibleMessageCount} mensagens visíveis
                      </div>
                      <p className="text-amber-900/80">
                        Role dentro da prévia do celular para navegar, ou pule direto para o
                        começo ou para a mensagem mais recente.
                      </p>
                    </div>
              ...
              <CardContent>
                    ...
                    <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
                      ...
                      <div className="flex items-center justify-between gap-2 rounded-full bg-slate-100 px-3 py-1 sm:justify-start">
                        ...
                        <Switch
                          ...
                          disabled={!hasDark}
                        />
                        <span className="text-xs text-slate-500">{isDark ? "Escuro" : "Claro"}</span>
                      </div>
                    </div>
                  </div>
                  <Button
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-slate-500">
                        {exportSettings.captureMode === "full"
                          ? `Exporta todas as mensagens visíveis numa imagem de ${exportSettings.width} x ${resolvedExportHeight}px.`
                          : exportSettings.captureMode === "screens"
                            ? `Divide a conversa em ${screenCount} prints do tamanho do celular, com base no tamanho de exportação atual.`
                            : "Exporta a tela do celular exatamente como aparece na prévia."}
                      </p>
                    </div>
                  </div>
                ...
                >
                  <DialogContent className="w-[94vw] max-w-5xl max-h-[88vh] overflow-y-auto">
                    ...
                    {quickPreviewError ? (
                      <div className="text-sm text-red-600">Falha ao exportar: {quickPreviewError}</div>
                    ) : null}
                    {quickPreviewUrls.length ? (
                      <div className="space-y-3">
                        ...
                        <div className="text-xs text-slate-500">
                          {quickPreviewUrls.length > 1
                            ? "Ao baixar, salva um arquivo por tela, em ordem."
          ...
          <Dialog>
            ...
            <DialogContent className="max-h-[80vh] overflow-y-auto">
              <DialogHeader>
                ...
                <DialogDescription>
                  Ao usar este app, você concorda com estes termos.
                </DialogDescription>
          ...
          <Dialog>
            ...
            <DialogContent className="max-h-[80vh] overflow-y-auto">
              <DialogHeader>
                ...
                <DialogDescription>
                  Esta política explica como os dados são tratados no app.
                </DialogDescription>
                <div className="text-xs text-slate-500">Last updated: 2026-01-03 | Version: 2026-01-03</div>
              </DialogHeader>
              <div className="space-y-4 text-sm text-slate-600">
