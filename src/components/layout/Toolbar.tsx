...
export const Toolbar = () => {
  ...
  const autosaveLabel = lastAutosaveAt
    ? `Salvo ${formatRelativeTime(lastAutosaveAt, now)}`
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 rounded-2xl border border-white/10 bg-white/70 px-4 py-3 shadow-lg backdrop-blur">
        <div className="flex w-full items-center gap-3 sm:w-auto">
          ...
          <div className="space-y-0.5">
            <div className="text-sm font-semibold text-slate-900">Gerador de Prints</div>
            <div className="text-xs text-slate-500">Monte e exporte prints de conversa</div>
        ...
        <div className="flex w-full flex-wrap items-center gap-2 sm:w-auto sm:justify-end">
          ...
          <div className="flex items-center gap-1 rounded-full border border-slate-200 bg-white/80 p-1 shadow-sm">
            <Tooltip>
              ...
              <TooltipContent>Desfazer (Ctrl/Cmd+Z)</TooltipContent>
            </Tooltip>
            <Tooltip>
              <TooltipTrigger asChild>
                <Button
              ...
              <TooltipContent>Refazer (Ctrl/Cmd+Shift+Z ou Ctrl/Cmd+Y)</TooltipContent>
            </Tooltip>
          </div>
          ...
          <Dialog open={isActionsOpen} onOpenChange={setIsActionsOpen}>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  Gerencie arquivos, dados salvos no navegador e utilitários.
                </DialogDescription>
              </DialogHeader>
          ...
          <Dialog open={isResetOpen} onOpenChange={setIsResetOpen}>
            <DialogContent>
              <DialogHeader>
                <DialogTitle>Zerar este projeto?</DialogTitle>
                <DialogDescription>
                  Isso apaga a conversa atual, o layout e o rascunho salvo. Não dá para desfazer esta ação.
                </DialogDescription>
              </DialogHeader>
