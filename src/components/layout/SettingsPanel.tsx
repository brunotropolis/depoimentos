...
export const SettingsPanel = () => {
  ...
  return (
    <div className="space-y-4">
      <div>
        <h3 className="text-sm font-semibold text-slate-900">Aparência e prévia</h3>
        <p className="text-xs text-slate-500">Controle o app, o tema e o comportamento da prévia.</p>
      </div>
      ...
      <div className="space-y-2">
        <Label>{isGroup ? "Nome do grupo" : "Conversa"}</Label>
        {isGroup ? (
          <Input
      ...
      <div className="flex items-center justify-between rounded-xl border border-slate-200 bg-white px-3 py-2">
        <div>
          <div className="text-sm font-medium text-slate-900">Tema</div>
          <div className="text-xs text-slate-500">Alterne entre claro e escuro.</div>
        </div>
        <Switch
          checked={isDark}
      ...
      <div className="flex items-center justify-between rounded-xl border border-slate-200 bg-white px-3 py-2">
        <div>
          <div className="text-sm font-medium text-slate-900">Moldura do app</div>
          <div className="text-xs text-slate-500">Mostra o cabeçalho e a barra de digitar.</div>
        </div>
      ...
      <div className="flex items-center justify-between rounded-xl border border-slate-200 bg-white px-3 py-2">
        <div>
          <div className="text-sm font-medium text-slate-900">Ajuste automático</div>
          <div className="text-xs text-slate-500">Encaixa a prévia no tamanho do painel.</div>
        </div>
          ...
          <div className="grid gap-3 sm:grid-cols-[120px_1fr]">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center justify-between text-xs text-slate-500">
                <span>Só fotos enviadas (melhor para exportar)</span>
                <Button
                  variant="ghost"
                  size="sm"
