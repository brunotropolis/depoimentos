...
export const ParticipantManager = () => {
  ...
  const validateFile = (file: File) => {
    ...
    if (file.size > 2 * 1024 * 1024) {
      return "A imagem deve ter menos de 2MB."
    }
    return null
  }
    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="text-xs text-slate-500">
          Gerencie contatos, fotos e escolha quem envia a próxima mensagem.
        </p>
      </div>
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <div className="flex-1 space-y-2">
                ...
                <div className="grid gap-2 sm:grid-cols-2">
                  ...
                  >
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="empty">Vazio (sem status)</SelectItem>
                    </SelectContent>
                  </Select>
                  <Input
                    type="color"
                ...
                <div className="flex items-center justify-between rounded-lg border border-slate-200 bg-slate-50 px-3 py-2">
                  <span className="text-xs font-medium text-slate-500">Selo de verificado</span>
                  <Switch
      ...
      <div className="rounded-xl border border-dashed border-slate-200 bg-white/70 p-3">
        <Label className="text-xs uppercase text-slate-400">Adicionar participante</Label>
        ...
        <div className="mt-2 flex flex-wrap items-center gap-2">
          ...
          />
          <span className="text-xs text-slate-500">Só fotos enviadas (melhor para exportar)</span>
          <input
            id="avatar-draft"
            type="file"
            accept="image/*"
